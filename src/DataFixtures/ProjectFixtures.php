...
class ProjectFixtures extends Fixture
{
    private const PROJECTS = [
        ...
        [
            ...
            'text' => "DevItEasy est un collectif spécialisée dans le développement web et web mobile. Elle a pour vocation de créer des sites web sur les différents supports existants. DevItEasy est née de l'association de 3 développeurs web passionnés en nouvelles technologies. L'objectif principal de DevItEasy est de rendre réel votre projet. Que ce soit un site vitrine, un site de e-commerce ou bien une application plus complexe (Intranet, Extranet, Web), nous saurons répondre à vos attentes. DevItEasy évolue en restant à la page des nouvelles technologies. Tous nos services évolueront avec le temps et les besoins de chacun."
        ],
    ];
